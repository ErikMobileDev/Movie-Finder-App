package com.erikmobiledev.pelifinder.ui.theme
...
private val DarkColorScheme = darkColorScheme(
    primary = Color(0xFF6B00C8),       // Purpura oscuro brillante
    secondary = Color(0xFF8C4CAF),     // Purpura más suave para acentos
